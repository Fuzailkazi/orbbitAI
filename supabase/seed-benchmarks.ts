...
export const benchmarks: BenchmarkSeed[] = [
  ...
  {
    name: "HumanEval",
    description: "Hand-written programming problems testing functional code generation (164 in the Python original). Orbbit runs the 161-problem JavaScript port (MultiPL-E humaneval-js), executed in a sandbox, pass@1.",
    category: "code",
  ...
  {
    name: "MBPP",
    description: "Mostly Basic Programming Problems — crowd-sourced entry-level tasks with natural language descriptions and test cases. Orbbit runs the JavaScript port (MultiPL-E), executed in a sandbox, pass@1.",
    category: "code",
    scoring_method: "pass_at_k",
    total_questions: 397,
    source_url: "https://huggingface.co/datasets/nuprl/MultiPL-E",
  ...
  {
    name: "MATH",
    description: "Competition-level math problems spanning algebra, geometry, number theory, counting, and probability. Orbbit runs the MATH-500 subset with final-answer matching.",
    category: "math",
    scoring_method: "normalized_match",
    total_questions: 500,
  ...
  {
    name: "MT-Bench",
    description: "Multi-turn benchmark with 80 high-quality questions across 8 categories. Orbbit scores the first turn of each question with an LLM judge.",
    category: "chat",
